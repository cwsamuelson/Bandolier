...
#define BNDLR_LOG_INFO(...) ::Bandolier::logging::core()->info((__VA_ARGS__));
...
#define BNDLR_INFORM(expression, ...) GSW_CHECK_AND(expression, BNDLR_LOG_INFO(__VA_ARGS__), __VA_ARGS__)
